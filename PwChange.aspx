<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PwChange.aspx.cs" Inherits="ProjectoFinal.LoginChange" %>
    ...
    <form id="form1" runat="server">
	 <div class="limiter">
		<div class="container-login100">
            ...
            <asp:Label ID="lblPerfilAct" runat="server" Text="Label"></asp:Label>
					</span></div>
			</div>
				<div class="login100-form validate-form">
					<asp:ValidationSummary ID="vlsLogin" runat="server" ForeColor="Red" DisplayMode="SingleParagraph" />
					<asp:Label ID="lblMensagem" runat="server" ForeColor="Red"></asp:Label>
					<div class="auto-style1" data-validate="Nome obritatório">
                   ...
                   <div class="wrap-input100 validate-input m-b-26" data-validate = "Perfil é obrigatório.">
					...
					<div class="container-login100-form-btn">
                        <asp:Button class="login100-form-btn" ID="btnLoginChange" runat="server" Text="Actualizar" OnClick="btnActualizar_Click" />
  						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
