                          ...
                          <div class="col-xl-6 col-lg-12">
                            <div class="whats-news-single mb-40 mb-40">
                              <div class="whates-img">
                                <img src="{item[1]/enclosure/@url}" alt="" />
                                                </div>
                              <div class="whates-caption">
                                <h4>
                                  <a href="{item[1]/link}">
                                    <xsl:value-of select="item[1]/title" disable-output-escaping="yes"/>
                                  </a>
                                </h4>
                                <span>
                          ...
                          <div class="col-xl-6 col-lg-12">
                            <div class="row">
                              ...
                              <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                <div class="whats-right-single mb-20">
                                  <div class="whats-right-img">
                                    <img src="{item[2]/enclosure/@url}" alt="" width="124" height="104" />
                                                        </div>
                                  <div class="whats-right-cap">
                                    ...
                                    <h4>
                                      <a href="{item[2]/link}">
                                        <xsl:value-of select="item[2]/title" disable-output-escaping="yes"/>
                                      </a>
                                    </h4>
                                    <p>
                              ...
                              <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                <div class="whats-right-single mb-20">
                                  <div class="whats-right-img">
                                    <img src="{item[3]/enclosure/@url}" alt="" width="124" height="104" />
                                                        </div>
                                  <div class="whats-right-cap">
                                    <span class="colorb">
                                    ...
                                    <h4>
                                      <a href="{item[3]/link}">
                                        <xsl:value-of select="item[3]/title" disable-output-escaping="yes"/>
                                      </a>
                                    </h4>
                                    <p>
                              ...
                              <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                <div class="whats-right-single mb-20">
                                  <div class="whats-right-img">
                                    <img src="{item[4]/enclosure/@url}" alt="" width="124" height="104" />
                                                        </div>
                                  <div class="whats-right-cap">
                                    <span class="colorg">
                                    ...
                                    <h4>
                                      <a href="{item[4]/link}">
                                        <xsl:value-of select="item[4]/title" disable-output-escaping="yes"/>
                                      </a>
                                    </h4>
                                    <p>
                              ...
                              <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                <div class="whats-right-single mb-20">
                                  <div class="whats-right-img">
                                    <img src="{item[5]/enclosure/@url}" alt="" width="124" height="104" />
                                                        </div>
                                  <div class="whats-right-cap">
                                    <span class="colorr">
                                    ...
                                    <h4>
                                      <a href="{item[5]/link}">
                                        <xsl:value-of select="item[5]/title" disable-output-escaping="yes"/>
                                      </a>
                                    </h4>
                                    <p>
                              ...
                              <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                <div class="whats-right-single mb-20">
                                  ...
                                  <div class="whats-right-cap">
                                    ...
                                    <h4>
                                      <a href="latest_news.html">Portrait of group of friends ting eat. market in.</a>
                                    </h4>
                                    <p>Jun 19, 2020</p>
                                  </div>
                                </div>
